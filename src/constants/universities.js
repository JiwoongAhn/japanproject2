...
export const universities = [
  ...
  // ── 배치 3 ────────────────────────────────────────────────────────────────
  {
    ...
    // 2026(令和8)年度からの昼間学部 授業時間割 (公式PDF: dendai.ac.jp/news/20250925-01.html 別紙)
    // 90分授業 / 休憩15分 / 昼休み70分. 工学部第二部(夜間 N1〜N7)は別体系のため未対応.
    periodRanges: {
      1: { start: 9 * 60 + 20,  end: 10 * 60 + 50 }, // 9:20 ~ 10:50
      2: { start: 11 * 60 + 5,  end: 12 * 60 + 35 }, // 11:05 ~ 12:35
      3: { start: 13 * 60 + 45, end: 15 * 60 + 15 }, // 13:45 ~ 15:15
      4: { start: 15 * 60 + 30, end: 17 * 60 },      // 15:30 ~ 17:00
      5: { start: 17 * 60 + 15, end: 18 * 60 + 45 }, // 17:15 ~ 18:45
    },
  },
  {
    id: 'tamagawa',
